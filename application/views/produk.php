...
<body class="hold-transition sidebar-mini">
											...
											?>
												<tr>
													...
													<td><i class="fas fa-trash mx-2 text-danger" data-toggle="modal" data-target="#modal-delete" onclick="deletemenuinit(<?= $value->id_produk ?>)"></i>
														<i class="fas fa-edit mx-2" onclick="editme(<?= $value->id_produk ?>)" style="cursor: pointer;" data-toggle="modal" data-target="#modal-edit"></i>
													</td>
												</tr>
											<?php endforeach; ?>
	...
	<script>
		function filter() {
			window.location.href = '../produkcrud'
		}
